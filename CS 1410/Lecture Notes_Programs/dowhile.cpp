...
int main()
{
	...
	do
	{
		...
		{
			case 'a':
			case 'A': cout << "You've chosen coffee" << endl;
					  validBeverage = true;
					  break;
			case 'b':
			case 'B': cout << "You've chosen tea" << endl;
					  validBeverage = true;
					  break;
			case 'c':
			case 'C': cout << "You've chosen hot chocolate" << endl;
					  validBeverage = true;
					  break;
			case 'd':
			case 'D': cout << "You've chosen cappuccino" << endl;
					  validBeverage = true;
					  break;
		...
		switch (beverage)
		{
			...
			case 'E': cout << " Please come again" << endl;
				break;
			default: cout << "You have entered an incorrect value" << endl;
